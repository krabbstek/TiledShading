#include "TiledForwardComputeLightTilesPass.h"
...
void TiledForwardComputeLightTilesPass::Render(std::vector<Renderable*>& renderables)
{
	m_ViewSpaceDepthTexture->Bind(0);
